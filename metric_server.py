# The collection layer: этот сервер собирает статистику процессов.
...
async def collector():
    """
    Собирает данные со всех запущенных экземпляров приложения
    в режиме реального времени по мере их поступления.
    """
